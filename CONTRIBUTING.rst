...
Github <https://github.com/ceholden/stems/issues>`__
...
The ``stems`` project follows a few conventions when
writing code:
...
2. Clone this copy to your machine:
   ...
   ::
       ...
       $ git clone git@github.com:YOUR_USERNAME/stems.git
       $ cd stems/
...
4. Continue your work while tracking significant, notable chunks of
   ...
   Push your code changes to your forked copy of ``stems``:
...
.. _TravisCI: https://travis-ci.org/ceholden/stems/
